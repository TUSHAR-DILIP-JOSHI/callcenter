...
<body>
    ...
    <form>
	    <p>SEARCH</P> <input type = "text" placeholder ="ENTER TEXT" name = "searchtext" required>	<br><br><br>
		
		<button type="button" name="searchname" value ="submitvalue" > SEARCH </button>
...
<ul class="ulclass">
  ...
  <li><a href="attainedcallsnew.php">ATTAINED CALLS NEW</a></li>
...
$sel_query = " Select * from insert_data WHERE !(call_attained_by IS NULL OR call_attained_by = '') ORDER BY id  ;";
